...
int main(int argc, char* argv[])
{
    try
    {
        ...
        /**
         * Form the request. We specify the "Connection: close" header so that the server will close the socket after transmitting the response.
        ...
        if (status_code != 200) {
             ...
             * status_code: 301 Response returned with status code 301
             * Date: Wed, 07 Apr 2021 02:10:46 GMT
             * Server: Apache/2.2.15 (CentOS)
             * Location: https://www.boost.org/LICENSE_1_0.txt\n
             * Content-Length: 326
             * Connection: close
